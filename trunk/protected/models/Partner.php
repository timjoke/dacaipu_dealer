...
class Partner extends CActiveRecord
{
    ...
    public function rules()
    {
        ...
        return array(
            ...
            array('partner_name,partner_key', 'required'),
            array('partner_key', 'length', 'max' => 50),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('partner_id, partner_name, partner_key', 'safe', 'on' => 'search'),
        );
    }
    ...
    public function search()
    {
        ...
        $criteria->compare('partner_key', $this->partner_key, true);
