...
/**
 * This is the model class for table "order_dish_flash".
 *
 * The followings are the available columns in table 'order_dish_flash':
 ...
 * @property string $is_presell
 */
class OrderDishFlash extends CActiveRecord
{
    ...
    public function rules()
    {
        ...
        return array(
            ...
            array('dish_recommend, dish_is_vaget, dish_spicy_level, dish_status, order_count, dish_mode,is_presell', 'numerical', 'integerOnly' => true),
            ...
            array('flash_id, dish_id, dish_name, dish_price, dish_recommend, dish_package_fee, dish_is_vaget, dish_spicy_level, dish_introduction, dish_category_id, dealer_id, dish_status, dish_createtime, order_id, order_count, order_sum_price, dish_mode, dish_group_no, dish_child_count, dish_quanpin, dish_jianpin,is_presell', 'safe', 'on' => 'search'),
        );
    }
    ...
    public function search()
    {
        ...
        $criteria->compare('is_presell', $this->is_presell, true);
     ...
     * @return OrderDishFlash the static model class
     */
     ...
     */
    public function getDishsByOrdersid($orderid)
    {
        $sql = 'SELECT
            order_dish_flash.flash_id,
            order_dish_flash.dish_name,
            order_dish_flash.dish_spicy_level,
            order_dish_flash.dish_is_vaget,
            order_dish_flash.dish_price,
            order_dish_flash.dish_package_fee,
            order_dish_flash.order_count,
            order_dish_flash.is_presell 
            FROM
            order_dish_flash
            WHERE
            order_dish_flash.order_id = ' . $orderid;
        $conn = Yii::app()->db;
        $cmd = $conn->createCommand($sql);

        $obj = $cmd->queryAll();
        $obj = new CArrayDataProvider($obj);
        $obj->keyField = 'flash_id';
        $obj->pagination->pageSize = 100000;
        return $obj;
    }
     ...
     * @return type
     */
    public function getOrderDishFlashByOrderId($order_id)
    {
        $sql = 'SELECT 
            order_dish_flash.dish_id as dish_id,
            order_dish_flash.dish_name as dish_name,
            order_dish_flash.dish_price as price,
            order_dish_flash.dish_package_fee as package_fee,
            order_dish_flash.order_count as count,
            order_dish_flash.order_sum_price as total_price
