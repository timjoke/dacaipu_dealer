 ...
 * @作者 roy
 */
class busWechatdsDefault
{

    public $http_static_url;
    /**
     * 默认首页接入
     */
    public function Proc($dealer_id)
    {
        try
        {
            ...
            array_push($news, array(
                ...
                'picurl' => $banner_url,
                'url' => Yii::app()->request->hostInfo . '/wechatds/dealer?dealer_id=' . $dealer_id . '&wechat_id=' . $fromUser . '&ts=' . $ts));
            ...
            if (in_array(1, $funcs))
            {
                array_push($news, array(
                    ...
                    'url' => Yii::app()->request->hostInfo . '/wechatds/takeout?dealer_id=' . $dealer_id . '&wechat_id=' . $fromUser . '&ts=' . $ts));
            }
            ...
            if (in_array(2, $funcs))
            {
                array_push($news, array(
                    ...
                    'url' => Yii::app()->request->hostInfo . '/wechatds/booking?dealer_id=' . $dealer_id . '&wechat_id=' . $fromUser . '&ts=' . $ts));
            }
            ...
            if (in_array(3, $funcs))
            {
                array_push($news, array(
                    ...
                    'url' => Yii::app()->request->hostInfo . '/wechatds/hall?dealer_id=' . $dealer_id . '&wechat_id=' . $fromUser . '&ts=' . $ts));
            }
            ...
            if (in_array(5, $funcs))
            {
                array_push($news, array(
                    ...
                    'description' => '订台点菜',
                    'picurl' => busUlitity::get_http_static_url() . 'mobile/img/tupian02.png',
                    'url' => Yii::app()->request->hostInfo . '/wechatds/eatin?dealer_id=' . $dealer_id . '&wechat_id=' . $fromUser . '&ts=' . $ts));
            }
            ...
            if (in_array(4, $funcs))
            {
                array_push($news, array(
                    ...
                    'url' => Yii::app()->request->hostInfo . '/wechatds/orders?dealer_id=' . $dealer_id . '&wechat_id=' . $fromUser . '&ts=' . $ts));
            }
