        ...
        <div class="MidArea" align="center">
            ...
            <table cellpadding="5" cellspacing="5" border="0" align="left" class="Table_1" >
                <tr height="35">
                    ...
                    <td><?php
                        echo busUlitity::formatDate($table_resermodel->reserv_start_time);
                        ?></td>
                </tr>
                <tr height="35">
                    ...
                    <td colspan="5">
                        <em>
                            ...
                            Yii::app()->clientScript->registerScript('submit', '$("#bt_agree").click(function(){' .
                                    ...
                                    '$("#processed_order_form")[0].action = "/OrderWaitProcess/agreeTable/id/' . $model->order_id . '";
        $("#processed_order_form").submit();
        });  '
                                    . '$("#bt_reject").click(function(){'
                                    . 'if($("#memo").val()==""){alert("拒绝请填写原因"); return false;} else{ $("#processed_order_form")[0].action = "/OrderWaitProcess/rejectTable/id/' . $model->order_id . '";'
                                    . '$(\'.ContArea\').mask(\'正在提交请稍后...\');'
                                    . '$("#processed_order_form").submit();}}); '
                            );
                            ?></em>
