<tr height="25" align="center">
    ...
    <td align="left"><?php
        ...
        ?></td>
    <td><span class="sp_money">￥</span><?php echo CHtml::encode($data['dish_price']); ?>+<span class="sp_money">￥</span><?php echo CHtml::encode($data['dish_package_fee']); ?></td>
    <td><?php echo CHtml::encode($data['order_count']); ?></td>
    <td>
        +<span class="sp_money">￥</span><?php echo busUlitity::formatMoney(($data['dish_price'] + $data['dish_package_fee']) * $data['order_count']); ?>
    </td>
</tr>