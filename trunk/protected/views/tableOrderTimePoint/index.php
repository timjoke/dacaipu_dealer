<?php
Yii::app()->clientScript->registerScript('left_script', '$("#li_tableOrderTimePoint").addClass("Active");');
...
<script type="text/javascript">
    function postDelete(obj, id) {
        openConfirmDialog("你确认删除该桌台时间吗？", function() {
            $.post("/tableOrderTimePoint/delete/id/" + id.toString(), "",
...
<div class="MiddleArea">
    <div class="ContentArea">
        <h2><span>桌台时间</span><em class="Btn">
                <a href="#" onclick="openDialogAuto('/tableOrderTimePoint/create', 'auto', 'auto', '添加桌台时间'); return false;" ><strong>+</strong>添加桌台时间</a></em></h2>
        <div class="ContArea">
            <div class="Bg"></div>
