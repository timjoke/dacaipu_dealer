<?php
Yii::app()->clientScript->registerScript('left_script', '$("#li_dealerServiceTime").addClass("Active");');
...
<script type="text/javascript">
    function postDelete(obj, id) {
        openConfirmDialog("你确认删除该时段吗？", function() {
            $.post("/dealerServiceTime/delete/id/" + id.toString(), "",
...
<div class="MiddleArea">
    <div class="ContentArea">
        <h2><span>营业时间</span><em class="Btn">
                <a href="#" onclick="openDialogAuto('/dealerServiceTime/create', 'auto', 'auto', '营业时间创建'); return false;" ><strong>+</strong>添加营业时间</a></em></h2>
        <div class="ContArea">
            <div class="Bg"></div>
